...
const HabitCard = memo(({ habit, completed, streak, onToggle, onEdit }: HabitCardProps) => {
  return (
    <div
    ...
    >
      <button
        onClick={onToggle}
        className={`flex h-12 w-12 shrink-0 items-center justify-center rounded-xl text-xl transition-transform active:scale-90 ${
